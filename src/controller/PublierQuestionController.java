 ...
 * @author arthas
 */
public class PublierQuestionController implements Initializable {
@FXML
    private TextField titreColumn;
@FXML
    private TextArea contenuColumn;
    ...
    try {
       ...
       public void handle(ActionEvent event) throws IOException {
           ...
           /*  Alert alert = new Alert(AlertType.CONFIRMATION, "Delete "  + " ?", ButtonType.YES, ButtonType.NO, ButtonType.CANCEL);
             alert.showAndWait();*/
            if(titreColumn.getText().length()<1 || contenuColumn.getText().length()<1 )
            {
            ...
            else if (titreColumn.getText().length()>100)
            {
             Alert alert = new Alert(AlertType.INFORMATION);
             alert.setTitle("Ajouter Question");
             alert.setHeaderText("Results:");
             ...
             alert.showAndWait();
              ...
              try {
                 ...
                 question = new Question(obs.getiduserdb().get(0).getId_userdb(),question.getDate_question(),titreColumn.getText(),contenuColumn.getText());
                   
                 qs.ajouterQuestion(question);
