 ...
 * @author arthas
 */
public class SignalerQuestionController implements Initializable {
...
public void handle(ActionEvent event) throws IOException {
           ...
           { Alert alert = new Alert(Alert.AlertType.INFORMATION);
              alert.setTitle("Signaler Question");
        ...
        alert.showAndWait();}
              ...
              try {
                ...
                signaler = new Signaler(obs.getiduserdb().get(0).getId_userdb(),obs.getidquestiondb().get(0).getId_questiondb(),contenu.getText(),signaler.getDate_signaler());

                ss.ajouter_signaler(signaler);
